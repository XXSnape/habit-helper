...
DELETE_PASSWORD: str = "❗Пожалуйста, запомните пароль и удалите его из переписки"
...
ABOUT_BOT: str = (
    ...
    "Помните, что после входа в профиль через другой аккаунт будет осуществлен автоматический выход из предыдущего "
